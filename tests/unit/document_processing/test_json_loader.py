...
class TestJSONLoader(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        loader = JSONLoader(
            ...
            content_key="content",
            metadata_keys=["title", "metadata.author"],
            json_lines=True
        )
    ...
    def test_load_invalid_json_lines(self, mock_logger):
        ...
        self.assertIn("Error decoding JSON at line 2", 
                      mock_logger.warning.call_args[0][0])

    @pytest.mark.skipif(
        not os.environ.get("JQ_AVAILABLE"),
        reason="jq library not available"
    )
