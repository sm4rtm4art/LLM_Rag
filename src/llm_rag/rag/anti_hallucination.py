...
def extract_key_entities(text: str) -> Set[str]:
    ...
    stop_words = {
        ...
        "zu", "von", "mit", "für", "bei", "bis", "um", "aus", "durch", 
        "nach", "über", "unter", "vor", "ist", "sind", "war", "waren", 
        "sein", "seine", "seinen", "seiner", "seines", "nicht", "auch", 
        "nur", "sehr", "so", "da", "hier", "dort", "dann", "denn", "weil", 
        "dass", "daß", "ob", "obwohl", "während", "wie", "wo", "wer", "was",
        "wessen", "wem", "wen", "sich", "ihr", "ihre", "ihres", "ihrem", "ihren"
    }
