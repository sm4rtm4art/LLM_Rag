"""Component factory for RAG pipeline components.
...
class RAGComponentFactory:
    ...
    def __init__(self):
        ...
        logger.info(
            f"RAGComponentFactory initialized with "
    ...
    def create_generator(self, generator_type: str = "llm", llm: BaseLanguageModel = None, **kwargs) -> BaseGenerator:
        ...
        try:
            ...
            if "prompt_template" not in kwargs or kwargs["prompt_template"] is None:
                from llm_rag.rag.pipeline.base import DEFAULT_PROMPT_TEMPLATE
            ...
            if generator_type == "llm":
                ...
                # For custom generators, pass all kwargs
