...
def extract_images_from_pdf(pdf_path, output_dir=None, save_images=False, compare=False, verbose=False):
    ...
    structural_extractor = PDFStructureExtractor(
        output_dir=output_dir, save_images=save_images, use_structural_image_extraction=True, verbose=verbose
    )
    ...
    if compare:
        ...
        text_extractor = PDFStructureExtractor(
            output_dir=output_dir, save_images=save_images, use_structural_image_extraction=False, verbose=verbose
        )
...
def process_directory(directory, output_dir=None, save_images=False, compare=False, verbose=False):
    ...
    for pdf_file in pdf_files:
        ...
        try:
            result = extract_images_from_pdf(
                pdf_path, output_dir=output_dir, save_images=save_images, compare=compare, verbose=verbose
            )
...
def main():
    """Execute the structural image extraction test."""
